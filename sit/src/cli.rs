...
pub fn execute_cli<MI>(repo: &Repository<MI>, cwd: &Path, subcommand: &str, args: Vec<String>, capture_stdout: bool) -> Result<(i32, Vec<u8>), Error>
    ...
    command.args(args);
    if capture_stdout {
        command.env("SIT_CAPTURE_STDOUT", "1");
